---
id: specification
title: "Portfolio Profile Specification"
sidebar_position: 2
description: "Full specification for the ADL Portfolio Profile Specification including agent inventory, relationships, and domain membership."
keywords: [adl, portfolio, specification, inventory, relationships, domain]
---
...
```json title="customer-service-agent.adl.json"
{
  "adl_spec": "0.1.0",
