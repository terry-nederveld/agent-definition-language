...
import calculatorYaml from '@versions/0.1.0/examples/with-tools.yaml';
import modelYaml from '@versions/0.1.0/snippets/with-tools/model.yaml';
import metadataYaml from '@versions/0.1.0/snippets/with-tools/metadata.yaml';
