---
name: "source-command-implement-proposal"
description: "Approve a proposal and spawn a team to implement and verify it against the proposal"
---

# source-command-implement-proposal

Use this skill when the user asks to run the migrated source command `implement-proposal`.
