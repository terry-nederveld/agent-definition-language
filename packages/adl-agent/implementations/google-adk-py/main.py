#!/usr/bin/env python3
"""
ADL Explainer Agent -- Google Generative AI Python SDK CLI entry point.
"""
...
from agent import SYSTEM_PROMPT, TOOLS, run_agent_turn
...
def main() -> None:
    ...
    while True:
        ...
        try:
            response = run_agent_turn(client, chat, user_input)
            print(f"\n{response}\n")
        except Exception as exc:
            print(f"\nError: {exc}\n", file=sys.stderr)
