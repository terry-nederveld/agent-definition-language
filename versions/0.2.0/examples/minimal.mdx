...
:::info Validation
This document validates against the [ADL JSON Schema](../#appendix-a-json-schema).
:::
...
- [Agent with Tools](./with-tools) - Add tool definitions
- [Production Agent](./production) - Full-featured example
