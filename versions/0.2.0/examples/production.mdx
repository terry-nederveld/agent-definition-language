...
import productionYaml from './production.yaml';
import identityYaml from '../snippets/production/identity.yaml';
import cryptoIdentityYaml from '../snippets/production/cryptographic-identity.yaml';
import permissionsYaml from '../snippets/production/permissions.yaml';
import securityYaml from '../snippets/production/security.yaml';
import runtimeYaml from '../snippets/production/runtime.yaml';
